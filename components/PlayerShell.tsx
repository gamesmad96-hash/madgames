'use client';
import { useRef,useState } from 'react'; import type { Game } from '@/lib/types';
export function PlayerShell({game}:{game:Game}){
 const [playing,setPlaying]=useState(false),[loading,setLoading]=useState(true),[frameKey,setFrameKey]=useState(0); const frameRef=useRef<HTMLDivElement>(null);
